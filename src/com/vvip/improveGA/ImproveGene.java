...
public class ImproveGene implements Comparable<ImproveGene> {
	int shortMA;
	int longMA;
	int macdMA;
	int fastK;
	...
	public ImproveGene(int shortMA, int longMA, int macdMA, int fastK, int slowK, int slowD) {
	...
	public ImproveGene(String binaryGene, double profit) {
	...
	@Override
	public int compareTo(ImproveGene gene) {
	...
	public String toString() {
		String str = " Profit : " + profit + "%" + " shortMA : " + shortMA + " longMA : " + longMA + " macdMA : " + macdMA + " fastK : " + fastK + " slowK : " + slowK + " slowD : " + slowD;
		return str;
